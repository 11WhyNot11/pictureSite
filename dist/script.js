...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var triggerDestroyed = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    close.addEventListener('click', function () {
      ...
      gift.style.marginRight = "0px"; // document.body.classList.remove('modal-open');
  ...
  function showModalByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // це для підтримки в 
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  showSlides(slideIndex); // при заході на сторінку показує перший слайд
